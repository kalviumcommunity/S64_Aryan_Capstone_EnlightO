            ...
            {studentViewCoursesList && studentViewCoursesList.length > 0 ? (
              studentViewCoursesList.map((courseItem) => (
                <Card
                  ...
                  className="cursor-pointer transition-transform duration-200 hover:shadow-lg hover:scale-[1.02] focus:shadow-lg focus:scale-[1.02]"
                  key={courseItem?._id}
                >
                      ...
                      <p className="text-[16px] text-gray-600 mt-3 mb-2">
                        {`${courseItem?.curriculum?.length || 0} ${
                          !courseItem?.curriculum?.length || courseItem?.curriculum?.length <= 1
                            ? "Lecture"
                            : "Lectures"
                        } - ${(courseItem?.level || 'Beginner').toUpperCase()} Level`}
                      </p>
